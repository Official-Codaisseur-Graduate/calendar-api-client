...
export default class CalendarIdForm extends React.Component {
  render() {
    return (
      <div className='form'>
        {this.props.message !== 'Calendar ID updated.' && (
          <Form onSubmit={this.props.onSubmit}>
            <Form.Group controlId='formBasicCalendarId'>
              ...
              <Form.Text className='text-muted'>
                You can find the <strong>Calendar ID</strong> from the Google
                Calendar under "Calendar settings" and down under the section{' '}
